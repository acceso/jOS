...
static inline void sleep_generic(u64 n, u32 d)
{
...
static inline u8 time_before_generic(u64 base, u32 nsecs, u64 divisor)
{
...
static inline void nsleep(u32 nsecs)
{
	sleep_generic(nsecs * sys.cpu[0].hz, 1000000000);
}


static inline u8 ntime_before(u64 base, u32 nsecs)
{
...
static inline void usleep(u32 usecs)
{
	sleep_generic(usecs * sys.cpu[0].hz, 1000000);
}


static inline u8 utime_before(u64 base, u32 usecs)
{
...
static inline void msleep(u32 msecs)
{
	sleep_generic(msecs * sys.cpu[0].hz, 1000);
}


static inline u8 mtime_before(u64 base, u32 msecs)
{
