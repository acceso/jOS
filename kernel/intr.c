...
static inline void ioapic_regsel(u8 reg)
{
...
static inline u8 ioapic_redir_nint_to_reg(u8 n)
{
	return n * 2 + 0x10;
}


static u64 ioapic_redir_read(u8 n)
{
	u64 v;
	u8 reg;
...
static void ioapic_redir_write(u8 n, u64 val)
{
...
static void ioapic_redir(u8 n, u64 val)
{
...
__isr__ do_lapic_err(struct intr_frame r)
{
	intr_enter();
...
__isr__ do_spurious(struct intr_frame r)
{
	intr_enter();
